...
class ECSDriver(NodeDriver):
    ...
    def create_node(self, name, size, image, auth=None,
                    ...
                    ex_client_token=None, ex_userdata=None,
                    ex_instance_charge_type=None,
                    **kwargs):
        """
        @inherits: :class:`NodeDriver.create_node`
        ...
        :keyword ex_userdata: UserData in Base64 format
        :type keyword ex_userdata: ``str``

        :keyword ex_instance_charge_type: InstanceChargeType in Base64 format
        :type keyword ex_instance_charge_type: ``str``
        """
        ...
        params = {'Action': 'CreateInstance',
                  ...
                  'InstanceName': name,
                  'InstanceChargeType':ex_instance_charge_type}
        if ex_userdata:
            params['UserData'] = ex_userdata

        if ex_instance_charge_type:
            params['InstanceChargeType'] = ex_instance_charge_type
